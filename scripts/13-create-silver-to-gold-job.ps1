<#
    13-create-silver-to-gold-job.ps1 - Create Glue Job for Silver to Gold transformation
...
Write-Step "Step 13: Create Silver to Gold Glue Job"
...
Write-Success "Silver to Gold job setup complete!"
